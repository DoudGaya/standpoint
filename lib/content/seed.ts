...
export const radioBulletins: RadioBulletin[] = [
  {
    id: "bulletin-1",
    title: "GlobHub Radio Hourly News Briefing",
    titleHa: "Labaran Sauti Na GlobHub Radio A Wannan Sa'ar",
    slug: "hourly-news-briefing",
    summary: "The latest headlines on global politics, trade, technology and regional developments.",
    summaryHa: "Kariyar labarai a sauti kan al'amuran duniya, kasuwanci da fasaha.",
    bulletinType: "hourly",
    audioUrl: "https://cdn.pixabay.com/download/audio/2022/05/27/audio_1808fbf07a.mp3?filename=news-intro-115383.mp3",
    duration: "3:45",
    publishedAt: "2026-08-25T17:00:00.000Z",
    language: "all",
    presenter: "GlobHub Radio Newsroom",
  },
  {
    id: "bulletin-ha-1",
    title: "Teburin Kano da Labaran Najeriya",
    titleHa: "Teburin Kano da Labaran Najeriya",
    slug: "teburin-kano-da-labaran-najeriya",
    summary: "Rahoton sauti na musamman kan harkokin kasuwanci da al'amuran yau da kullum a Kano da Najeriya.",
    summaryHa: "Rahoton sauti na musamman kan harkokin kasuwanci da al'amuran yau da kullum a Kano da Najeriya.",
    bulletinType: "daily",
    audioUrl: "https://cdn.pixabay.com/download/audio/2022/05/27/audio_1808fbf07a.mp3?filename=news-intro-115383.mp3",
    duration: "4:20",
    publishedAt: "2026-08-25T16:30:00.000Z",
    language: "ha",
    presenter: "Bari a Sauti — GlobHub Hausa",
  },
  {
    id: "bulletin-2",
    title: "Global Cities Climate Pact Audio Overview",
    titleHa: "Bayanin Sauti Kan Yerjejeniyar Sauyin Yanayi Na Biranen Duniya",
    slug: "climate-pact-audio-overview",
    summary: "A 5-minute audio briefing explaining the 18-city climate adaptation agreement.",
    summaryHa: "Bayanin sauti na minti 5 kan yarjejeniyar sauyin yanayi da birane 18 suka kulla.",
    bulletinType: "article",
    audioUrl: "https://cdn.pixabay.com/download/audio/2022/05/27/audio_1808fbf07a.mp3?filename=news-intro-115383.mp3",
    duration: "5:12",
